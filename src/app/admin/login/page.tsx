export default function AdminLoginPage() {
  return (
    <main className="mx-auto grid min-h-screen max-w-md place-items-center px-5">
      <div className="w-full rounded-brand border border-line bg-white p-6 shadow-soft" role="group">
        ...
        <input autoComplete="email" className="mt-6 w-full rounded-brand border border-line px-4 py-3" id="admin-email" name="email" placeholder="E-mail" type="email" />
        <button className="mt-4 w-full cursor-not-allowed rounded-brand bg-ruby px-5 py-3 font-redhat text-sm font-semibold text-white opacity-50" disabled type="button">Pokračovat</button>
      </div>
    </main>
  );
}
